  ...
  <body>
    ...
    <div id="main">
      <div id="wrapper" class="flex">
        <div>
        <p style="margin-top: 10px;margin-right:10px;"><font size="3">データベースにユーザーを追加・削除できます。</p>
        <div id="input_form">
        ...
        <div>
        <p style="margin-top: 10px;margin-right:10px;"><font size="3">データベースにdisknodeを追加・削除できます。</p>
        <div id="input_form">
          <form action="admin.php" method="post" onsubmit="return submitChk()">
